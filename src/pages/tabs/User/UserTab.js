    ...
    <IonPage>
      <DefaultPageLayout title="Utilizador" icon={personOutline}>
        <div className={styles.content}>
          ...
          <IonButton mode="ios" expand="block" fill="clear" color="dark" href="/notabs/conta" >
            <div className={styles.option}><IonIcon icon={personCircleOutline} className={styles.icon} />A Minha Conta</div>
          </IonButton>
          <IonButton mode="ios" expand="block" fill="clear" color="dark" href="/notabs/estatuto">
            <div className={styles.option}><IonIcon icon={fileTrayFullOutline} className={styles.icon} />Estatuto Especial</div>
          </IonButton>
          <IonButton mode="ios" expand="block" fill="clear" color="dark" href="/notabs/metodospagamento">
            <div className={styles.option}><IonIcon icon={cardOutline} className={styles.icon} />Métodos de Pagamento</div>
          </IonButton>
          <IonButton mode="ios" expand="block" fill="clear" color="dark" href="/login" onClick={() => dispatch(actions.logOut())}>
